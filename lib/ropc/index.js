...
var errorSenders = require("../common/errorSenders")("password");
var handleAuthenticatedResource = require("../common/handleAuthenticatedResource")("username", errorSenders);


module.exports = function restifyOAuth2Ropc(server, options) {
    ...
    if (typeof options.hooks.grantUserToken !== "function") {
        throw new Error("Must supply grantUserToken hook.");
    }
    ...
    server.use(function ropcOAuth2Plugin(req, res, next) {
