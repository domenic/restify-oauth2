...
module.exports = function (grantTypes, reqPropertyName, requiredHooks, grantToken) {
    var errorSenders = require("../common/errorSenders")(grantTypes);
    var handleAuthenticatedResource = require("../common/handleAuthenticatedResource")(reqPropertyName, errorSenders);
