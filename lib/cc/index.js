...
var errorSenders = require("../common/errorSenders")("client_credentials");
var handleAuthenticatedResource = require("../common/handleAuthenticatedResource")("clientId", errorSenders);


module.exports = function restifyOAuth2CC(server, options) {
    if (typeof options.hooks !== "object" || options.hooks === null) {
        throw new Error("Must supply hooks.");
    }
    if (typeof options.hooks.grantClientToken !== "function") {
        throw new Error("Must supply grantClientToken hook.");
    }
