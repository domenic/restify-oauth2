...
var hasBearerToken = require("./utils").hasBearerToken;
...
module.exports = function createOauth2Plugin(options) {
    ...
    options = _.defaults(options, {
        ...
        requiresTokenPredicate: function (req) { return req.path !== "/"; }
    });
    ...
    return function oauth2Plugin(req, res, next) {
        ...
        } else if (options.requiresTokenPredicate(req) || hasBearerToken(req)) {
